...
import DataStructure.QueryResult;
 ...
 * </p>
 * <p>
 * Klasse DataStructure.DatabaseConnector
 * </p>
 * <p>
 * Ein Objekt der Klasse DataStructure.DatabaseConnector ermoeglicht die Abfrage und Manipulation
...
public class DatabaseConnector{
  ...
  /**
   * Ein Objekt vom Typ DataStructure.DatabaseConnector wird erstellt, und eine Verbindung zur Datenbank
  ...
  public void executeStatement(String pSQLStatement){  
    ...
    try {
      ...
      if (statement.execute(pSQLStatement)) { //Fall 1: Es gibt ein Ergebnis
        ...
        //DataStructure.Queue fuer die Zeilen der Ergebnistabelle erstellen
        Queue<String[]> rows = new Queue<String[]>();

        //Daten in DataStructure.Queue uebertragen und Zeilen zaehlen
        int rowCount = 0;
        ...
        //Ergebnisfeld erstellen und Zeilen aus DataStructure.Queue uebertragen
   ...
   * die Datenbank geschickten SQL-Befehls als Ob-jekt vom Typ DataStructure.QueryResult zurueck.
